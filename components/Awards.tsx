  ...
  <div className="relative font-neutralFace">
    ...
    <div className="absolute top-[35%] right-[10%]">
      <Image
        alt=""
        src={award1}
        className="h-28 sm:h-44 md:h-80 z-10 object-contain w-auto"
      />
    </div>
    ...
    <div className="absolute bottom-[30%] left-[60%]">
      <Image
        alt=""
        src={award4}
        className="h-28 sm:h-32 md:h-52 z-10 object-contain w-auto"
      />
    </div>
    ...
    <div className="absolute bottom-[15%] right-[35%]">
      <Image
        alt=""
        src={award6}
        className="h-28 sm:h-32 md:h-48 z-10 object-contain w-auto"
      />
    </div>
  </div>
);
